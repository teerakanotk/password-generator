 ...
 * @param {boolean} options.excludeSimilar
 * @param {boolean} options.excludeDuplicate
 * @param {boolean} options.beginWithLetter
 * @param {number} length - Desired password length.
 * @returns {string} Generated password or "" if impossible.
 */
